...
#    define LOG_ERROR(...)                                                                         \
        do {                                                                                       \
            LA_LOG_STREAM << "LA ERROR (" << __FUNCTION_NAME__ << "): " << __VA_ARGS__             \
                          << std::endl;                                                            \
        } while (false)
#else
...
#    define LOG_WARNING(...)                                                                       \
        do {                                                                                       \
            LA_LOG_STREAM << "LA WARNING: (" << __FUNCTION_NAME__ << "): " << __VA_ARGS__          \
                          << std::endl;                                                            \
        } while (false)
#else
...
#    define LOG_INFO(...)                                                                          \
        do {                                                                                       \
            LA_LOG_STREAM << "LA INFO: (" << __FUNCTION_NAME__ << "): " << __VA_ARGS__             \
                          << std::endl;                                                            \
        } while (false)
#else
...
#    define LOG_DEBUG(...)                                                                         \
        do {                                                                                       \
            LA_LOG_STREAM << "LA DEBUG: (" << __FUNCTION_NAME__ << "): " << __VA_ARGS__            \
                          << std::endl;                                                            \
        } while (false)
#else
...
#    define LOG_TRACE(...)                                                                         \
        do {                                                                                       \
            LA_LOG_STREAM << "LA TRACE: (" << __FUNCTION_NAME__ << "): " << __VA_ARGS__            \
                          << std::endl;                                                            \
        } while (false)
#else
