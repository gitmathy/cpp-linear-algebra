...
auto operator+(const matrix<T> &left, const matrix<T> &right)
{
    typedef expressions::binary_expression<matrix<T>, matrix<T>,
                                           expressions::add_operation<matrix<T>, matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator+(const matrix<T> &left, const expressions::operant<ExpT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::add_operation<matrix<T>, expressions::operant<ExpT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator+(const expressions::operant<ExpT> &left, const matrix<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::add_operation<expressions::operant<ExpT>, matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator+(const matrix<T> &left, const T &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::add_operation<matrix<T>, expressions::literal<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator+(const T &left, const matrix<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::add_operation<expressions::literal<T>, matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator+(const sparse_matrix<T> &left, const sparse_matrix<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::add_operation<sparse_matrix<T>, sparse_matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
