...
///
/// @file la/operation/substraction.hpp
/// @brief Definition substracting structures
/// @author Gitmathy, https://github.com/gitmathy
///
/// @copyright Copyright (c) 2026. All rights reserved.
/// Licensed under the MIT License (see LICENSE file in project root).

#ifndef LA_OPERATIONS_SUBSTRACTION_HPP
#define LA_OPERATIONS_SUBSTRACTION_HPP
...
/// @brief matrix - matrix
template <typename T>
auto operator-(const matrix<T> &left, const matrix<T> &right);
...
auto operator-(const vector<T> &left, const vector<T> &right)
{
    typedef expressions::binary_expression<vector<T>, vector<T>,
                                           expressions::sub_operation<vector<T>, vector<T>>>
        new_bin_exp_type;
...
auto operator-(const vector<T> &left, const expressions::operant<ExpT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<vector<T>, expressions::operant<ExpT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const expressions::operant<ExpT> &left, const vector<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::operant<ExpT>, vector<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const vector<T> &left, const T &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<vector<T>, expressions::literal<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const T &left, const vector<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::literal<T>, vector<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const static_vector<T, N> &left, const static_vector<T, N> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<static_vector<T, N>, static_vector<T, N>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const static_vector<T, N> &left, const expressions::operant<ExpT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<static_vector<T, N>, expressions::operant<ExpT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const expressions::operant<ExpT> &left, const static_vector<T, N> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::operant<ExpT>, static_vector<T, N>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const static_vector<T, N> &left, const T &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<static_vector<T, N>, expressions::literal<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const T &left, const static_vector<T, N> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::literal<T>, static_vector<T, N>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const expressions::operant<ExpLT> &left, const expressions::operant<ExpRT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::operant<ExpLT>, expressions::operant<ExpRT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const T &left, const expressions::operant<ExpT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::literal<T>, expressions::operant<ExpT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const expressions::operant<ExpT> &left, const T &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::operant<ExpT>, expressions::literal<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const matrix<T> &left, const matrix<T> &right)
{
    typedef expressions::binary_expression<matrix<T>, matrix<T>,
                                           expressions::sub_operation<matrix<T>, matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const matrix<T> &left, const expressions::operant<ExpT> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<matrix<T>, expressions::operant<ExpT>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
...
auto operator-(const expressions::operant<ExpT> &left, const matrix<T> &right)
{
    typedef expressions::binary_expression<
        ...
        expressions::sub_operation<expressions::operant<ExpT>, matrix<T>>>
        new_bin_exp_type;
    return expressions::operant<new_bin_exp_type>(new_bin_exp_type(left, right));
}
} // namespace la
